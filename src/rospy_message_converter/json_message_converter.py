...
def convert_ros_message_to_json(message, binary_array_as_str=True):
    """
    ...
    """
    dictionary = message_converter.convert_ros_message_to_dictionary(message, binary_array_as_str)
